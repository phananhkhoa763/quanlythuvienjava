...
/**
 * Provides the local service interface for phieugiahan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LAPTOP
 * @see phieugiahanLocalServiceUtil
...
public interface phieugiahanLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link phieugiahanLocalServiceUtil} to access the phieugiahan local service. Add custom service methods to {@link danhmuc.service.impl.phieugiahanLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
