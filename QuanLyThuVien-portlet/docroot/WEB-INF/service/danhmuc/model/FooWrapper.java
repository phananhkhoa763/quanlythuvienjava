...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public int compareTo(danhmuc.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<danhmuc.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public danhmuc.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public danhmuc.model.Foo toUnescapedModel() {
