...
import danhmuc.service.phieugiahanLocalService;
...
/**
 * Provides the base implementation for the phieugiahan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link danhmuc.service.impl.phieugiahanLocalServiceImpl}.
 * </p>
 *
 * @author LAPTOP
 * @see danhmuc.service.impl.phieugiahanLocalServiceImpl
 * @see danhmuc.service.phieugiahanLocalServiceUtil
 * @generated
 */
public abstract class phieugiahanLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements phieugiahanLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link danhmuc.service.phieugiahanLocalServiceUtil} to access the phieugiahan local service.
	 */
	...
	@Override
	public phieugiahan addphieugiahan(phieugiahan phieugiahan)
		throws SystemException {
		phieugiahan.setNew(true);

		return phieugiahanPersistence.update(phieugiahan);
	}
	 ...
	 */
	@Override
	public phieugiahan createphieugiahan(long id) {
		return phieugiahanPersistence.create(id);
	}
	...
	@Override
	public phieugiahan deletephieugiahan(long id)
		throws PortalException, SystemException {
		return phieugiahanPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public phieugiahan deletephieugiahan(phieugiahan phieugiahan)
		throws SystemException {
		return phieugiahanPersistence.remove(phieugiahan);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(phieugiahan.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return phieugiahanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return phieugiahanPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return phieugiahanPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public phieugiahan fetchphieugiahan(long id) throws SystemException {
		return phieugiahanPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public phieugiahan getphieugiahan(long id)
		throws PortalException, SystemException {
		return phieugiahanPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return phieugiahanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<phieugiahan> getphieugiahans(int start, int end)
		throws SystemException {
		return phieugiahanPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getphieugiahansCount() throws SystemException {
		return phieugiahanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public phieugiahan updatephieugiahan(phieugiahan phieugiahan)
		throws SystemException {
		return phieugiahanPersistence.update(phieugiahan);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("danhmuc.model.phieugiahan",
			phieugiahanLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"danhmuc.model.phieugiahan");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = phieugiahanPersistence.getDataSource();
	...
	private phieugiahanLocalServiceClpInvoker _clpInvoker = new phieugiahanLocalServiceClpInvoker();
}